...
use Auth;
// App\Link and Shortlink bring in Link.php and Shortlink.php, which were created by creating the Models
use App\Link;
use App\Shortlink;
...
class LinkController extends Controller
{
    ...
    {
        // Link::find() uses Eloquent https://laravel.com/docs/7.x/eloquent
        $link = Link::find($id);
        return $link;
    }
